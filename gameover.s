...
gameover:
	...
	ldr r5 , =sound_data_2  @変更しない
	ldr r6 , =rhythm_data_2 @変更しない
...
time_2:
	...
	.word 0x0, 0x0
melody_2:
	@マリオが死んだ時の音楽：シ4,ファ5,休,ファ5,ファ5,ミ5,休,レ5,ド5
	@鳴らしたい音を数字にする
	.word 6,12,24,12,12,11,24,9,7
rhythm_2:
	@鳴らしたいリズムを数字にする
	@符号
...
sound_data_2:
	...
	.word 12260, 11566, 10909, 10300, 9726, 9177, 8664, 8177, 7717, 7283, 0
rhythm_data_2:
	@リズムデータ
	@2分音符, 4分音符,  8分音符,16分音符,付点4分音符,付点8分音符
	.word 1200000 ,600000   , 300000 , 150000 ,900000  ,450000
